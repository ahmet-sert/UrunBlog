<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UrunBilgi.aspx.cs" Inherits="UrunBilgiBlog.UrunBilgi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="title">
            <h2>
                <asp:Literal ID="ltrl_isim" runat="server"></asp:Literal></h2>
        </div>
        <div class="image">
