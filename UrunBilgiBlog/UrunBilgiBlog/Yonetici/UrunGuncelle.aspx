<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici/Yonetici.Master" AutoEventWireup="true" CodeBehind="UrunGuncelle.aspx.cs" Inherits="UrunBilgiBlog.Yonetici.UrunGuncelle"  ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/FormDesign.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> <div class="formContainer">
        <div class="formtitle">
            <h3>Ürün Güncelle</h3>
        </div>
        <div class="formContent">
            <asp:Panel ID="pnl_basarili" runat="server" CssClass="basariliMesaj" Visible="false">
                <label>Ürün Güncelleme İşlemi Başarıyla Gerçekleştirildi</label>
            </asp:Panel>
            ...
            <div style="width:650px; float:left">
                <div class="row">
                    ...
                    <asp:TextBox ID="tb_fiyat" runat="server" CssClass="formInput" TextMode="MultiLine"></asp:TextBox>
                </div>
                <div class="row">
            ...
            <div class="row" style="clear:both">
                <asp:LinkButton ID="lbtn_guncelle" runat="server"  OnClick="lbtn_guncelle_Click" CssClass="formButton">Ürün Ekle</asp:LinkButton>
            </div>
        </div>
    </div>
