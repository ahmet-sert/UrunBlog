<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="KullaniciGuncelle.aspx.cs" Inherits="UrunBilgiBlog.KullaniciGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class=" girisForm form">
        ...
        <div class="row" style="text-align:center">
            <asp:LinkButton ID="lbtn_gncl" runat="server" Text="Güncelle"OnClick="lbtn_gncl_Click" CssClass=" UyeButton"></asp:LinkButton>
